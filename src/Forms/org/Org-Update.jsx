...
import { useClickOutside, useOrg, useOrgId, setOrgErrorMessage } from '@/global';
...
const OrgUpdate = ({setShowUpdateOrgPopup, forCreation, setForCreation}) => {
    ...
    useClickOutside(updatePppupRef, ()=> {if (forCreation) {
     ...
     <div
      ...
      <div
       ...
       bg-white dark:bg-zinc-950' 
        >
          <div
           className='flex flex-col items-cente gap-2'
           >
            <span
             className='text-xl'
             >
            ...
            <span
             ...
             >
              {forCreation ? "create Organization By filling this all Deatils" :"Enter your new Organization Name. If you'd like to update your profile picture, you can upload a new one as well."}
            </span>
          </div>
          <form
           ...
           >
               ...
               <Input
                ...
                <FileInput
                 ...
                 id='profile-Picture'
                 accept='image/*'
                 label2={previewUrl ? <img className='h-full w-full object-cover' src={previewUrl}/> :<BiImageAdd size={30} className='group-hover:scale-105 smooth'/>}
             ...
             <div 
              ...
              >
               <BlueBtn isLoading={orgLoading} text={forCreation ? "create" :'Update'}/>
             </div>
          </form>
       </div>
     </div>
