import { BlueBtn, Input } from '@/components';
import { setOrgErrorMessage, useClickOutside, useOrg } from '@/global';
        ...
        <div
           ...
           className='flex flex-col gap-1'>
            ...
            <div className='flex flex-col gap-2 items-center justify-center'>
               <span className='text-xl font-semibold'>Invite Member to {org?.orgName}</span>
               <span className='text-sm text-zinc-500'>Send an invitation by entering the email address of the person you'd like to add to your organization.</span>
            </div>
            <form
