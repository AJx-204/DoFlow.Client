    ...
    <main className='p-6 '>
       <div className='flex flex-col gap-8'>
         ...
         <div className='flex flex-col gap-3'>
            <div className='flex gap-10'>
              <div className='flex items-center justify-center overflow-hidden w-20 h-20 bg-slate-200 dark:bg-zinc-950 rounded-full -ml-1'>
                {org?.orgProfilePhoto ? <img className='h-full w-full object-cover' src={org.orgProfilePhoto} alt={org.orgName} /> : < SlOrganization className='text-yellow-500'  size={40}/>}
              </div>
              <i
         ...
         <div className='flex flex-col gap-4'>
            <span
             ...
             >
             <AiOutlineUsergroupAdd size={20} className='text-amber-500 cursor-pointer hover:text-amber-700'/>
              WorkForce
            </span>
            <AvatarGroup maxVisible={org?.members?.length} className='ml-6 flex-wrap max-w-[330px]' users={org?.members?.map(m => m.member)}/>
         </div>
         {/* project info */}
          <div className='flex flex-col gap-4'>
            <span
         ...
         <div
          ...
          >
           <span
            ...
            <p
             className='max-w-[350px] text-sm ml-5'
             >
            ...
            <div className='flex ml-6'>
               ...
               <IconBtn onClick={() => (setShowLeaveOrgPopup(true), dispatch(setOrgErrorMessage('')))} icon={<LogOut size={18} className='rotate-180'/>} text='Leave' className='text-sm px-3 py-2 hover:bg-red-500/15 rounded-md text-red-500 max-w-[max-content]'/>
           </div>
         </div>
         <div
          className='flex flex-col gap-2'
          >
           <span
            ...
            <div className='max-w-[350px] text-sm ml-5 '>
              Deleting this organization is a permanent action and <span className="font-semibold text-red-500">cannot be undone</span>.
              This will:
            ...
            <div className='flex ml-6'>
               <CornerDownRight className='text-zinc-500' strokeWidth={1}/>
               <IconBtn onClick={()=>setShowConformation(true)} icon={<RiDeleteBin6Line size={18}/>} text='Delete' className='text-sm px-3 py-2 hover:bg-red-500/15 rounded-md text-red-500 max-w-[max-content]'/>
           </div>
         </div>
       </div>
       ...
       {showConformation && 
        <Conform
          ...
          p2={'You must enter the correct organization name to confirm deletion. Only the organization owner can perform this action.'}
          cancelText={'Cancle'}
          conformText={'Delete'}
       ...
       {showLeaveOrgPopup && 
        <Conform
          ...
          cancelText={'Cancel'}
          conformText={'Leave'}
          onCancel={() => setShowLeaveOrgPopup(false)}
