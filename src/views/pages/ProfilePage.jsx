        ...
        {/* profile info */}
          ...
          <div className='flex flex-col gap-2'>
             ...
             {user?.inProject?.length > 0 ? (
               user?.inProject?.map((p)=>(
                 <div key={p.project._id} className='flex gap-2 text-sm items-center ml-4 text-zinc-600 dark:text-zinc-400'>
          ...
          <div className='flex flex-col gap-2'>
             ...
             <div className='flex gap-4 ml-4 text-sm'>
               <IconBtn onClick={()=>lightTheme()} text='Light' icon={<Sun size={18}/>} className='p-4 rounded-md text-black bg-white border border-black '/>
               <IconBtn onClick={()=>darkTheme()} text='Dark' icon={<Moon size={18}/>} className='p-4 rounded-md text-white bg-black border border-white '/>
             </div>
          </div>
          {/* Forgot Password */}
          <div className='flex flex-col gap-2'>
