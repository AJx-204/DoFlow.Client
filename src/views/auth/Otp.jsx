...
import { BlueBtn, Input, Logo, useVerifyOtp, setErrorMessage, useResendOtp, DotLoader} from '../../global'
        ...
        <div className='p-6 w-[330px] bg-white border dark:bg-zinc-950 flex flex-col gap-3 border-zinc-500/30 rounded-lg shadow-md'>
            ...
            <div className='flex flex-col items-center text-center gap-1'>
              ...
              <span className='text-sm text-zinc-500'>
                Verify your Gmail by OTP that we sent to your Gmail account <span className='text-blue-600'>{user?.userEmail}</span>
              </span>
            </div>
            <form
             ...
             className='flex flex-col gap-3 mt-2'>
                <div className='flex flex-col gap-1 items-center'>
                 ...
                 <div className='flex items-center justify-center mt-5'>
                   <BlueBtn onClick={()=>dispatch(setErrorMessage(null))} isLoading={authLoading} className='apple' text='Verify OTP'/>
                 </div>
