...
import { updateUserProfile, setErrorMessage, setAuthLoading, useNotifier, } from '../../global'
...
const useUpadteUser = () => {
    ...
    const updateUser = async (data) => {
      try {
          ...
          dispatch(setErrorMessage(error.response?.data?.message || 'profile Update failed !'))
          return false;
      } finally {
