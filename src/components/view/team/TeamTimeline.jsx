     ...
     <div className='relative inter'>
      <div
       ...
       className={`${showTimeLines ? "border-zinc-500" : "hover:border-zinc-500 border-zinc-500/50"} p-1.5 cursor-pointer flex items-center group justify-center shadow-md rounded-full border z-100`}>
        ...
        <span className='w-[max-content] absolute group-hover:flex hidden top-9 left-0 text-xs px-2 py-1 bg-zinc-500/20 border border-zinc-500/50 backdrop-blur-2xl rounded-md'>Time Line</span>
      </div>
      {showTimeLines && 
      <div 
       ref={TimelineRef}
