...
const Conform = ({title, p1, p2, cancelText='Cancel', conformText, onCancel, onConform, danger, loding, error, input, label, setInput}) => {
  ...
  return (
    <div
     className='fixed top-0 left-0 w-screen h-screen bg-black/80 flex items-center justify-center z-100'
     >
      <div
       ref={conformRef}
       ...
       >
        ...
        <div
         className='flex gap-2 self-end mt-3'
         >
           <>
            <Btn
             onClick={onCancel}
